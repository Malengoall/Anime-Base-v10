    ...
    switch (command) {
        ...
        await sendCarousel(sock, jid, [
          {
            ...
            body:
              ...
              `> ┃༆ ping\n> ┃༆ info\n> ┃༆ owner\n> ┃༆ runtime\n` +
              `> ┗━━━━━━━━━━━━━━━─`,
            btnLabel: "📢 CHANNEL", btnUrl: settings.whatsappChannel,
          },
          {
            title: "🛡️ TOOLS",
            body:
          ...
          },
          {
            ...
            body:
              ...
              `> ┃༆ public\n> ┃༆ self\n> ┃༆ rentbot\n> ┃༆ pair\n` +
              `> ┗━━━━━━━━━━━━━━━─`,
            btnLabel: "💬 GROUP", btnUrl: settings.whatsappGroup,
          },
          {
            title: "👑 PREMIUM",
            body:
      ...
      case "ping": {
        ...
        await sendInteractive(sock, jid, {
          ...
          body: `⚡ Response: *${ms}ms*\n✅ Bot is online`,
          footer: settings.footerText, btnLabel: "📢 Channel", btnUrl: settings.whatsappChannel,
        }, m);
        break;
      }
